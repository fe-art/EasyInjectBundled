...
public class InstallerWindow extends JFrame {
    ...
    private com.easyinject.Main.ModrinthInstance modrinthInstance;
    private boolean mcsrBlocked;
    ...
    public com.easyinject.Main.ModrinthInstance getModrinthInstance() { return modrinthInstance; }
    public boolean isMcsrBlocked()          { return mcsrBlocked; }
    ...
    public void setModrinthInstance(com.easyinject.Main.ModrinthInstance m) { this.modrinthInstance = m; }
    public void setMcsrBlocked(boolean b)         { this.mcsrBlocked = b; }
